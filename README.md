...
> 本项目完全由 **DeepSeek-v4-pro** 在 **20 分钟** 内自动生成，源码压缩后仅 **90KB**，运行时内存占用仅 **20MB** —— 一款真正"即开即用"的轻量级 AI 助手。
...
* **四种思考模式** —— 快速（无深度思考）、思考（开启 deep_think）、沉思（附加 DeepThink.json 提示词）、静思（附加 Medit.json 提示词）。
